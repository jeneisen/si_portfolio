		...
		mywebsite.prototype.animateHomeimg = function() {
			return jQuery("#home .welcome_block").waypoint(function() {
				return new Animo({
					...
					el: jQuery("#home .welcome_block p.opacity"),
					duration: 1500,
					delay: 1300,
					template: {
						opacity: [0, 1],
					...
					el: jQuery("#home .welcome_block span.opacity"),
					duration: 1500,
					delay: 1600,
					template: {
						opacity: [0, 1],
					...
					el: jQuery("#home .welcome_block a.opacity"),
					duration: 1500,
					delay: 1500,
					template: {
						opacity: [0, 1],
